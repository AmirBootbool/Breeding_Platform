...
class GermplasmAdmin(admin.ModelAdmin):
    list_display = ['name', 'germplasm_db_id', 'program', 'cross_type', 'year_developed', 'created_at']
...
class CrossAdmin(admin.ModelAdmin):
    list_display = ['cross_code', 'female_parent', 'male_parent', 'cross_date', 'location', 'created_at', 'updated_at']
