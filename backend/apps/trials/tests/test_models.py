...
def test_generate_rcbd_layout_consistency(program=None):
...
def test_create_plots_for_trial():
    ...
    trial = Trial.objects.create(
        name='RCBD Test', trial_code='TR1', program=program, location=location, season=season, design_type='RCBD', num_reps=2
    )
